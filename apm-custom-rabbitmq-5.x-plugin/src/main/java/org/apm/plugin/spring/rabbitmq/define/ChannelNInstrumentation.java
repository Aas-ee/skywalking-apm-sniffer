...
public class ChannelNInstrumentation extends ClassInstanceMethodsEnhancePluginDefine {
    public static final String INTERCEPTOR_CLASS = "org.apm.plugin.spring.rabbitmq.RabbitMQProducerInterceptor";
    ...
    public static final String INTERCEPTOR_CONSTRUCTOR = "org.apm.plugin.spring.rabbitmq.ChannelNConstructorInterceptor";
    public static final String CONSUME_ENHANCE_METHOD = "basicConsume";
    public static final String CONSUME_INTERCEPTOR_CONSTRUCTOR = "org.apm.plugin.spring.rabbitmq.RabbitMQConsumerInterceptor";
